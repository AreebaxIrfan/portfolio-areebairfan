    ...
    return (
        <div className='bg-black text-white flex flex-col md:flex-row items-center justify-center p-4  md:p-8 relative'>
            ...
            <div className='w-full md:w-1/2 mx-auto md:ml-16 md:mr-10 text-center md:text-left mb-8 md:mb-0 relative z-10 sm:p-1 p-6 font-sans'>
                ...
                <h2 className='text-3xl sm:text-4xl lg:text-4xl font-semibold mb-6 text-pink-600 font-serif'>Frontend Developer</h2>
                <p className='text-base sm:text-lg mb-8 font-mono'>
                ...
                <div className='relative inline-block mx-auto md:mx-0'>
                    ...
                    <div className='absolute top-14 left-1/2 sm:left-2/3 transform -translate-x-1/2 flex space-x-4 mt-6'>
                        ...
                        <SocialLink href="https://www.facebook.com/AreebaxIrfan" icon={<FaFacebook />} />
            ...
            {/* Image Section */}
            <div className='w-full md:w-1/2 relative flex justify-center items-center pt-10 sm:pt-1
            sm:justify-end lg:ml-16 md:mr-16 mt-8 md:mt-0'>
